...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='comment',
            name='code_language',
            field=models.CharField(blank=True, max_length=20, null=True, verbose_name='Мова коду'),
        ),
        migrations.AddField(
            model_name='comment',
            name='has_code',
            field=models.BooleanField(default=False, verbose_name='Містить код'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('html', 'HTML'), ('css', 'CSS'), ('javascript', 'JavaScript'), ('react', 'React'), ('interview', 'Питання до співбесід'), ('career', "Кар'єра"), ('other', 'Інше')], default='other', max_length=20, verbose_name='Категорія')),
